...
const currentYear = new Date().getFullYear()
    ...
    return(
        <footer id="blogFooter" className="border-top">
            <div className="container px-4 px-lg-5 py-5">
                <div className="row gx-4 gx-lg-5 justify-content-center pt-2">
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        <ul className="list-inline text-center">
                            <li className="list-inline-item">
                                    <a href={instagram} target="_blank" rel="noopener noreferrer">
                                     <span className="fa-stack fa-lg">
                                        <svg className="svg-inline--fa fa-circle fa-stack-2x" style={{ color: footerColor }} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512z"></path></svg>
                            ...
                            <li className="list-inline-item">
                                    ...
                                    <span className="fa-stack fa-lg" >
                                        <svg className="svg-inline--fa fa-circle fa-stack-2x" style={{ color: footerColor }} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512z"></path></svg>
                                        <svg className="svg-inline--fa fa-facebook-f fa-stack-1x fa-inverse" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook-f" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path></svg>
                                    </span>
                                </a>
                            </li>
                            <li className="list-inline-item">
